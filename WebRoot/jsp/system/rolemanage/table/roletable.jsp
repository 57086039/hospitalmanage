...
<c:forEach items="${roles}" var="item">
	<tr class="rowTr">
		...
		<td>${item.note}</td>
		<td>
			<a class="btn btn-link btn-edit" href="javascript:location.href='${ctx}/roleController/toedit.do?id=${item.id}';">修改</a>
			<a class="btn btn-link btn-delete" href="javascript:;" onclick="deleterole('${item.id}')">删除</a>
		</td>
	</tr>
</c:forEach>
