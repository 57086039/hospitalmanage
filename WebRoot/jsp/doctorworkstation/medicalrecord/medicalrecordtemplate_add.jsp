		...
		<div class="main-container container-fluid">			
			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/medicalrecordtemplateController/add.do" method="post">
							...
							<div class="span3">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" value="新病例模板" readonly="readonly"/>
						...
						<div class="row-fluid row1">
							...
							<div class="span3">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" name="fitstatus"/>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid row2">
							...
							<div class="span10">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<textarea class="span12 textarea-c" name="patientappeal"></textarea>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid row2">
							...
							<div class="span10">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<textarea class="span12 textarea-c" name="medicalhistory"></textarea>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid row2">
							...
							<div class="span10">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<textarea class="span12 textarea-c" name="physicalstatus"></textarea>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid row2">
							...
							<div class="span10">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<textarea class="span12 textarea-c" name="opinion"></textarea>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
