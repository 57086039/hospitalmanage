		...
		<div class="main-container container-fluid">
			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/medicalrecordController/edit.do" method="post">
						...
						<div class="row-fluid row1">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input id="medicalrecordnote" type="text" name="note" value="${medicalrecord.note}"/>
									</div>
								</div>	
							</div><!--/span-->
						...
						<div class="row-fluid row2">
							...
							<div class="span10">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<textarea class="span12 textarea-c" id="patientappeal" name="patientappeal">${medicalrecord.patientappeal}</textarea>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid row2">
							...
							<div class="span10">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<textarea class="span12 textarea-c" id="medicalhistory" name="medicalhistory">${medicalrecord.medicalhistory}</textarea>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid row2">
							...
							<div class="span10">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<textarea class="span12 textarea-c" id="physicalstatus" name="physicalstatus">${medicalrecord.physicalstatus}</textarea>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->
						...
						<div class="row-fluid row2">
							...
							<div class="span10">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<textarea class="span12 textarea-c" id="opinion" name="opinion">${medicalrecord.opinion}</textarea>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->						
