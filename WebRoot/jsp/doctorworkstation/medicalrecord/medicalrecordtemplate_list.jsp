...
<html lang="en">
	...
	<body resize="resize()">
				...
				<div class="page-content">
					...
					<div class="row-fluid">
						...
						<div class="span4">
							<div class="control-group control-group-m">
								...
								<div class="controls controls-l">
									<input id="templatecode" type="text" onkeyup="search()"/>
								</div>
							</div>	
						</div><!--/span-->
						...
						<div class="span4">
							<div class="control-group control-group-m">
								...
								<div class="controls controls-l">
									<input id="templatename" type="text" onkeyup="search()"/>
								</div>
							</div>	
						</div><!--/span-->
					...
					<div class="row-fluid">
						...
						<div class="span4">
							...
							<div class="controls controls-l">
								<input id="fitstatus" type="text" onkeyup="search()"/>
							</div>
						</div>
					...
					<div class="row-fluid">
						...
						<div id="tableleft" class="span4" style="width:53.5%;overflow:auto;min-width:230px;">							
		...
		<script type="text/javascript">					
			var ctx = "${ctx}";
			var controller = "/medicalrecordtemplateController";
			var sumrow;
			var currentpage;
		</script>
		...
		<script type="text/javascript">
			...
			function find(page){
				...
				var fitstatus = $("#fitstatus").val();
				gettable(templatecode,templatename,doctorid,departmentid,fitstatus,page);
			}
