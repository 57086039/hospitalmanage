		...
		<div class="main-container container-fluid" style="z-index:3000;">			
			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/prescriptiontemplateController/add.do" method="post" >
						...
						<div class="row-fluid">
							...
							<div class="span3">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input id="department" name="" type="text" readonly="readonly"/>
									</div>
								</div>		
							</div><!--/span-->
