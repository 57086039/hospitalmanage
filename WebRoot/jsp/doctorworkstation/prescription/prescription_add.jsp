	...
	<body>
		<div class="main-container container-fluid">			
			...
			<div class="main-content">
				...
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/prescriptionController/add.do" method="post" >
						...
						<div class="row-fluid">
							...
							<div class="span3">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input id="prescriptionnote" name="note" type="text" />
									</div>
								</div>	
							</div><!--/span-->
						...
						<div class="row-fluid">
							...
							<div class="span3">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input id="medicineamount" type="text" readonly="readonly"/>
									</div>
								</div>	
							</div><!--/span-->
						</div><!--/.row-fluid-->	
		...
		<script type="text/javascript">
			...
			function gettemplatetable(str){
				$.post("${ctx}/prescriptionController/templatetablelist.do",
				{contant:str},
				function(data){
			...
			function getdrugtable(str){
				$.post("${ctx}/drugController/drugtablelist.do",
				{contant:str},
				function(data){
					$("#drugdatas").html(data);
				});
			...
			function drugbackfill(drugid,drugcode,drugname,norms,inventoryquantity){
				...
				$("#norms").val(norms);
				itqt = inventoryquantity;
				$("#dosagequantity").val(0);
				$("#eachdosage").val(0);
				$("#medicineform").val(0);
