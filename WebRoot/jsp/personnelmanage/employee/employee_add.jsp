		...
		<div class="main-container container-fluid">
			<div class="main-content">
				<div class="page-content">
					...
					<form id="validation-form" class="form-horizontal" action="${ctx}/employeeController/add.do" method="post" enctype="multipart/form-data">
						...
						<div class="row-fluid">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<input type="text" id="employeename" name="employeename" onkeyup="getpinyin()"/>
									</div>
								</div>								
								<div class="control-group control-group-m">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									<div class="controls controls-m">
										...
										<img style="width:150px; height:170px; " id="img_file" onclick="F_Open_dialog()">
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<div class="controls-radio">
											<label style="display:inline-block;">
												<input name="isoperator" type="radio" value="1"/>
												<span class="lbl"> 是</span>
											</label>
		
											<label style="display:inline-block;">
												<input name="isoperator" type="radio" value="2"/>
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<div class="controls-radio">
											<label style="display:inline-block;">
												<input name="isdoctor" type="radio" value="1"/>
												<span class="lbl"> 是</span>
											</label>
		
											<label style="display:inline-block;">
												<input name="isdoctor" type="radio" value="2"/>
												<span class="lbl"> 否</span>
											</label>
										</div>
									</div>
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<div class="controls-radio">
											<label style="display:inline-block;">
												<input name="isnurse" type="radio" value="1"/>
												<span class="lbl"> 是</span>
											</label>
		
											<label style="display:inline-block;">
												<input name="isnurse" type="radio" value="2"/>
												<span class="lbl"> 否</span>
											</label>
										</div>
									</div>
							...
							<div class="span4">
								<div class="control-group control-group-m">
									...
									<div class="controls controls-m">
										<span class="text-m" >
											<div class="row-fluid input-append">
												<input class="span10 date-picker" name="dimissiontime" style="width:193px;" type="text" data-date-format="yyyy-mm-dd" disabled="disabled"/>
												<span class="add-on" style="float:right;">
													<i class="icon-calendar"></i>
												</span>
											</div>
